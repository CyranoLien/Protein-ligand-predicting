...
def model_3dcnn(proshape, ligshape):
    ...
    adam = Adam(lr=0.0001, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.00005)
...
def lets_train_cnn(filename):
    ...
    history = model.fit_generator(gen_train, steps_per_epoch=NUM_TRAIN*3, epochs=EPOCH)
    #, validation_data=gen_valid, validation_steps=NUM_TRAIN*3)
